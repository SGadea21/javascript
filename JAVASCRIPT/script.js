...
// Definir el objeto con usuarios y contraseñas válidas
...
function iniciarSesion() {
    ...
    if (!usuarioIngresado) {
        alert("Inicio de sesión cancelado. Refresque la página para intentarlo nuevamente.");
        return false; // Devuelve false si no se ingresó un nombre de usuario
    }
    ...
    if (usuariosValidos.hasOwnProperty(usuarioIngresado) && usuariosValidos[usuarioIngresado] === contraseñaIngresada) {
        ...
        alert("Nombre de usuario o contraseña incorrectos. Refresque la página para intentarlo nuevamente.");
